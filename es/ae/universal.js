 ...
 */
export const Universal = Ae.compose(Account, Chain, Transaction, Aens, ContractACI, Oracle, {
  init () {},
  props: { process: {} }
})

export const UniversalWithAccounts = Ae.compose(Accounts, Chain, Transaction, Aens, ContractACI, Oracle, Selector, {
  init () {},
  props: { process: {} }
})
