...
declare module '@stamp/it' {
  ...
  */
  type FactoryFunction<Obj> = (options?: PropertyMap, ...args: any[]) => stampit.StampObjectType<Obj>

  /**
  * @internal Chainables `Stamp` additionnal methods
  * @template Obj The object type that the `Stamp` will create.
  */
  type StampChainables<Obj> = Chainables<stampit.StampObjectType<Obj>, StampType<Obj>>

  /**
  * @internal Chainables `Stamp` additionnal methods
  * @template Obj The object type that the `Stamp` will create.
  * @template Stamp The type of the `Stamp` (when extending a `Stamp`.)
  */
  interface Chainables<Obj, Stamp extends StampSignature> {
    /**
    ...
    methods<This = Obj>(...methods: Array<MethodMap<This>>): Stamp
     ...
     */
    properties(...objects: PropertyMap[]): Stamp

    /**
     * Take a variable number of objects and shallow assign them to any future created instance of the Stamp. Creates and returns new Stamp. **Chainable**.
     * @param objects Object(s) to shallow assign for each new object.
     */
    props(...objects: PropertyMap[]): Stamp
     ...
     */
    deepProperties(...deepObjects: PropertyMap[]): Stamp

    /**
     * Take a variable number of objects and deeply merge them to any future created instance of the Stamp. Creates and returns a new Stamp. **Chainable**.
     * @param deepObjects The object(s) to deeply merge for each new object.
     */
    deepProps(...deepObjects: PropertyMap[]): Stamp
     ...
     */
    initializers(...functions: Array<stampit.Initializer<Obj, Stamp>>): Stamp
    initializers(functions: Array<stampit.Initializer<Obj, Stamp>>): Stamp
     ...
     * @param functions Initializer functions used to create private data and privileged methods.
     */
    init(...functions: Array<stampit.Initializer<Obj, Stamp>>): Stamp
    init(functions: Array<stampit.Initializer<Obj, Stamp>>): Stamp
     ...
     */
    staticProperties(...statics: PropertyMap[]): Stamp

    /**
     * Take n objects and add them to a new stamp and any future stamp it composes with. Creates and returns new Stamp. **Chainable**.
     * @param statics Object(s) containing map of property names and values to mixin into each new stamp.
     */
    statics(...statics: PropertyMap[]): Stamp
     ...
     */
    staticDeepProperties(...deepStatics: PropertyMap[]): Stamp

    /**
     * Deeply merge a variable number of objects and add them to a new stamp and any future stamp it composes. Creates and returns a new Stamp. **Chainable**.
     * @param deepStatics The object(s) containing static properties to be merged.
     */
    deepStatics(...deepStatics: PropertyMap[]): Stamp
     ...
     */
    composers(...functions: Array<stampit.Composer<Stamp>>): Stamp
    composers(functions: Array<stampit.Composer<Stamp>>): Stamp
     ...
     */
    configuration(...confs: PropertyMap[]): Stamp

    /**
     * Shallowly assign properties of Stamp arbitrary metadata and add them to a new stamp and any future Stamp it composes. Creates and returns a new Stamp. **Chainable**.
     * @param confs The object(s) containing metadata properties.
     */
    conf(...confs: PropertyMap[]): Stamp
     ...
     */
    deepConfiguration(...deepConfs: PropertyMap[]): Stamp

    /**
     * Deeply merge properties of Stamp arbitrary metadata and add them to a new Stamp and any future Stamp it composes. Creates and returns a new Stamp. **Chainable**.
     * @param deepConfs The object(s) containing metadata properties.
     */
    deepConf(...deepConfs: PropertyMap[]): Stamp
     ...
     * @param descriptors
     */
    propertyDescriptors(...descriptors: PropertyDescriptorMap[]): Stamp

    /**
     * Apply ES5 property descriptors to a Stamp and any future Stamp it composes. Creates and returns a new stamp. **Chainable**.
     * @param descriptors
     */
    staticPropertyDescriptors(...descriptors: PropertyDescriptorMap[]): Stamp
  }
  ...
  */
  // tslint:disable-next-line: no-unnecessary-generics
  function stampit<Obj = any> (...composables: stampit.Composable[]): StampType<Obj>
  ...
  */
  ...
  /**
     ...
     * @template Stamp The type of the `Stamp` (when extending a `Stamp`.)
     */
  interface Descriptor<Obj, Stamp extends StampSignature = stampit.Stamp<Obj>> {
    ...
    initializers?: Initializer<Obj, Stamp> | Array<Initializer<Obj, Stamp>> | undefined
    ...
    composers?: Array<Composer<Stamp>> | undefined | Function
  ...
  /**
     ...
     * @template Stamp The type of the `Stamp` (when extending a `Stamp`.)
     */
  interface ExtendedDescriptor<Obj, Stamp extends StampSignature = stampit.Stamp<Obj>> extends Descriptor<Obj, Stamp> {
    /** A set of properties that will be added to new object instances by assignment. */
    ...
    /** An array of functions that will run in sequence while creating an object instance from a `Stamp`. `Stamp` details and arguments get passed to initializers. */
    init?: Initializer<Obj, Stamp> | Array<Initializer<Obj, Stamp>> | undefined
    /** A set of options made available to the `Stamp` and its initializers during object instance creation. These will be copied by assignment. */
     ...
     */
    type Initializer<Obj, Stamp extends StampSignature> = (this: Obj, options: /* _propertyMap */ any, context: InitializerContext<Obj, Stamp>) => void | Obj
     ...
     * @template Stamp The type of the `Stamp` producing the instance.
     */
    interface InitializerContext<Obj, Stamp extends StampSignature> {
     ...
     */
    type Composer<Stamp extends StampSignature> = (parameters: ComposerParameters<Stamp>) => void | Stamp

    /**
     * The parameters received by the current `.composers` function.
     * @template Stamp The type of the `Stamp` produced by the `.compose()` method.
     */
    interface ComposerParameters<Stamp extends StampSignature> {
    ...
    interface Stamp<Obj> extends FactoryFunction<Obj>, StampChainables<Obj>, StampSignature {
      ...
      // ! This has been added manually since it exists as a field
      // ! in the implementation but not in the specification.
     ...
     * @param functions Initializer functions used to create private data and privileged methods
     */
    function initializers<Obj = any, Stamp extends StampSignature = StampType<Obj>> (
      // tslint:disable-next-line: no-unnecessary-generics
      ...functions: Array<Initializer<StampObjectType<Obj>, Stamp>>
    ): Stamp
    function initializers<Obj = any, Stamp extends StampSignature = StampType<Obj>> (
      // tslint:disable-next-line: no-unnecessary-generics
      functions: Array<Initializer<StampObjectType<Obj>, Stamp>>,
     ...
     * @param functions Initializer functions used to create private data and privileged methods
     */
    function init<Obj = any, Stamp extends StampSignature = StampType<Obj>> (
      // tslint:disable-next-line: no-unnecessary-generics
      ...functions: Array<Initializer<StampObjectType<Obj>, Stamp>>
    ): Stamp
    function init<Obj = any, Stamp extends StampSignature = StampType<Obj>> (
