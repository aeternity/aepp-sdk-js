...
describe('Amount Formatter', function () {
  ...
  it('format', () => {
    [
      ...
      [1, AE_AMOUNT_FORMATS.MEGA_AETTOS, AE_AMOUNT_FORMATS.AE, asBigNumber(0.000000000001)],
      [1, AE_AMOUNT_FORMATS.MEGA_AETTOS, AE_AMOUNT_FORMATS.AETTOS, asBigNumber(1000000)],
      [1e6, AE_AMOUNT_FORMATS.AETTOS, AE_AMOUNT_FORMATS.MEGA_AETTOS, asBigNumber(1)],
      [0.0001, AE_AMOUNT_FORMATS.MEGA_AETTOS, AE_AMOUNT_FORMATS.AE, asBigNumber(0.0000000000000001)],
      [0.000000000001, AE_AMOUNT_FORMATS.AE, AE_AMOUNT_FORMATS.MEGA_AETTOS, asBigNumber(1)],
      [0.000001, AE_AMOUNT_FORMATS.MEGA_AETTOS, AE_AMOUNT_FORMATS.AETTOS, asBigNumber(1)],
      [0.000000000001, AE_AMOUNT_FORMATS.TERA_AETTOS, AE_AMOUNT_FORMATS.AETTOS, asBigNumber(1)],
      [0.000001, AE_AMOUNT_FORMATS.TERA_AETTOS, AE_AMOUNT_FORMATS.MEGA_AETTOS, asBigNumber(1)]
    ].forEach(
